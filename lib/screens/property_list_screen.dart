  ...
  void _scrapeData() async {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Scrape Land Listings'),
        content: Text('This will start scraping land listings for "$location". '
...
// Use the existing string extension from another file if available,
// or move this to a separate utilities file if needed